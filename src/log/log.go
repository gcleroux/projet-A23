...
type Log struct {
	// Technically, we could have the mutex moved to the segments themselves
	// This would improve perf by not limiting reads to other segments while
	// writing to the activeSegment
	mu sync.RWMutex
